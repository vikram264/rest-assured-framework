...
@Slf4j
public class HTTPGet implements HTTPRequest<RequestBase, HTTPResponse> {
    @Override
    public HTTPResponse composeAndSendRequest(RequestBase requestBase)  {
        ...
        log.info("Received the HTTP Get call for the end point {}", requestBase.getEndPoint());
        ...
        Response response = RestAssured
                ...
                .when()
                .get(requestBase.getEndPoint());

        log.info("Response of HTTP Get for the end point {} is {} ", requestBase.getEndPoint() ,response.prettyPrint());
